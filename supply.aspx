<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supply.aspx.cs" Inherits="Spicyo.supply" %>
     ...
     <%-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
      ...
      <%-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        ...
        <form class="main_form" runat="server">
            ...
            <asp:Label ID="Label1" runat="server"  Visible="false" Text="ordered"></asp:Label>
            <asp:Label ID="Label2" runat="server" Class="col-form-label-lg" Text="Item id:"></asp:Label>
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="id" DataValueField="id"></asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbs_mini_projectConnectionString %>" SelectCommand="SELECT [id] FROM [order] WHERE ([status] = @status)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="Label1" Name="status" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource> 
            <asp:Button ID="Button1" runat="server"  Text="Deliver" OnClick="Button1_Click" />
            <asp:Label ID="Label3" runat="server" Class="col-form-label-lg" Text="Updated" Visible="false"></asp:Label><br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Height="248px" Width="851px">
                <Columns>
                    <asp:BoundField DataField="id" HeaderText="ID" SortExpression="id" InsertVisible="False" ReadOnly="True" />
                    <asp:BoundField DataField="name" HeaderText="ITEM NAME" SortExpression="name" />
                    <asp:BoundField DataField="lcount" HeaderText="LARGE" SortExpression="lcount" />
                    <asp:BoundField DataField="mcount" HeaderText="MEDIUM" SortExpression="mcount" />
                    <asp:BoundField DataField="tcount" HeaderText="TOTAL" SortExpression="tcount" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbs_mini_projectConnectionString %>" SelectCommand="SELECT [id], [name], [lcount], [mcount], [tcount], [total], [status] FROM [order] WHERE ([status] = @status)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="Label1" Name="status" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
