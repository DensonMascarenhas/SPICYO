<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modify_menu.aspx.cs" Inherits="Spicyo.modify_menu" %>
     ...
     <%-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
      ...
      <%-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        ...
        <form class="main_form" runat="server">
            ...
            <asp:Button ID="Button2" runat="server" Text="View" style="height: 26px"  OnClick="Button2_Click" Height="100" Width="100" />
            <asp:DataList ID="DataList1" runat="server" DataKeyField="item_no" DataSourceID="SqlDataSource1" RepeatColumns="1">
                <ItemTemplate>
                    <table class="w-100">
                        <tr>
                            <td>
                                <asp:Image ID="Image1" runat="server" Height="300px" ImageUrl='<%# Eval("image") %>' Width="400px" />
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td class="auto-style1">
                                <asp:Label ID="Label5" Class="col-form-label-lg" runat="server" Text="Large Price"></asp:Label>
                            </td>
                            <td class="auto-style1">
                                <asp:TextBox ID="TextBox1" class="form-control-lg" runat="server" Text='<%# Eval("large_price") %>'></asp:TextBox>
                            </td>
                            <td class="auto-style1"></td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label8" Class="col-form-label-lg" runat="server" Text="Small Size"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox2" class="form-control-lg" runat="server" Text='<%# Eval("medium_price") %>'></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label9" Class="col-form-label-lg" runat="server" Text="Stauts"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="DropDownList3" class="dropdown-toggle-split" runat="server">
                                    <asp:ListItem>Available</asp:ListItem>
                                    <asp:ListItem>Unavailable</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label10" Visible="false" Class="col-form-label-lg" runat="server" Text="Discount"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox3" Visible="false" class="form-control-lg" runat="server" Text='<%# Eval("discount") %>'></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label11" Class="col-form-label-lg" runat="server" Text="Description"></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="TextBox4" class="form-control-lg" runat="server" Text='<%# Eval("discription") %>' Height="100px" Width="600px"></asp:TextBox>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Button ID="Button1" runat="server" Class="send" Text="ADD" OnClick="Button1_Click" />
                            </td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                        </tr>
